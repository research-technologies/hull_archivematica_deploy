...
sudo -u root systemctl restart archivematica-storage-service

# Setup superuser (requires input)
sudo -u archivematica bash -c " \
    set -a -e -x
...
# Setup Mounts
# transfer_source https://docs.microsoft.com/en-us/azure/storage/files/storage-how-to-use-files-linux
# DIP https://docs.microsoft.com/en-us/azure/storage/files/storage-how-to-use-files-linux
# AIP: https://docs.microsoft.com/en-us/azure/storage/blobs/storage-how-to-mount-container-linux
# ?other
